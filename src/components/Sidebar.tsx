        ...
        <nav className="p-4">
          <ul className="space-y-2">
            <li>
              <Link
                to="/"
                className="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md group transition-colors"
              >
            ...
            <li>
              <Link
                ...
                className="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md group transition-colors"
              >
                <AlertTriangle className="mr-3 h-5 w-5 text-gray-400 group-hover:text-white" />
                Alerts
              </Link>
            </li>
            <li>
              <Link
                ...
                className="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md group transition-colors"
              >
                <BarChart className="mr-3 h-5 w-5 text-gray-400 group-hover:text-white" />
                Analytics
              </Link>
            </li>
          </ul>
